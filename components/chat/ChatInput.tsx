...
export function ChatInput({ onSend, isLoading, placeholder }: ChatInputProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="relative z-20">
            <div className="glass-panel rounded-2xl p-2 border-white/10 shadow-2xl relative">
                ...
                <div className="relative flex gap-2 items-end">
                    ...
                    <button
                        ...
                        className="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 disabled:from-gray-700 disabled:to-gray-800 disabled:opacity-50 disabled:cursor-not-allowed text-white flex items-center justify-center transition-all shadow-lg hover:shadow-indigo-500/25 hover:scale-105 active:scale-95"
                    >
                        {isLoading ? (
            ...
            <p className="text-[10px] text-gray-500 text-center mt-1.5 font-medium tracking-wide">
